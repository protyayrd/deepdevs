...
export default function CustomPagesPage() {
    ...
    const resetForm = () => {
        setShowForm(false);
        setEditingItem(null);
        setForm({ slug: '', title: '', content: '', metaDescription: '', isPublished: true });
    };
    ...
    return (
        <div className="space-y-8 animate-fade-in-up is-visible pb-20">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <AdminButton onClick={() => setShowForm(true)} className="shadow-lg shadow-indigo-100">
                    + Create New Page
                </AdminButton>
            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <textarea
                                    ...
                                    placeholder="<h1>Welcome</h1><p>Content...</p>"
                                />
                                <p className="text-xs text-gray-400 font-medium pl-1 italic">
                        ...
                        <div className="mt-8 flex items-center justify-between border-t border-gray-50 pt-6">
                            <div className="flex gap-2">
                                <button
                                    onClick={() => {
                                        setEditingItem(p);
                                        setForm({ slug: p.slug, title: p.title, content: p.content, metaDescription: p.metaDescription || '', isPublished: p.isPublished });
                                        setShowForm(true);
                                    }}
