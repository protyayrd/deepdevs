          ...
          <div className="mt-8 sm:mt-10 w-full max-w-[1120px] flex flex-col gap-6 sm:gap-8 px-4 lg:px-0">
            <div className="w-full flex flex-col md:flex-row gap-8 justify-center">
              ...
              <div className="w-full md:w-[352px] box-border flex flex-col items-center gap-6 p-6 md:px-6 md:py-[30px] bg-white border border-[#D6D6D6] rounded-[20px]">
                <svg width="90" height="98" viewBox="0 0 90 98" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
              ...
              <div className="w-full md:w-[352px] box-border flex flex-col items-center gap-6 p-6 md:px-6 md:py-[30px] bg-white border border-[#D6D6D6] rounded-[20px]">
                <svg width="110" height="98" viewBox="0 0 112 98" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
              ...
              {/* Card: Ask with AI */}
              <div className="w-full md:w-[352px] box-border flex flex-col items-center gap-6 p-6 md:px-6 md:py-[30px] bg-white border border-[#D6D6D6] rounded-[20px]">
                <svg width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
            ...
            <div className="w-full flex flex-col md:flex-row gap-8 justify-center">
              {/* Card: Scanner */}
              <div className="w-full md:w-[352px] box-border flex flex-col items-center gap-6 p-6 md:px-6 md:py-[30px] bg-white border border-[#D6D6D6] rounded-[20px]">
                <svg width="98" height="98" viewBox="0 0 98 130" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
        ...
        <div className="w-full max-w-[1440px] flex flex-col items-center py-12 sm:py-16 px-4 sm:px-6 lg:px-0">
          ...
          <div className="w-full max-w-[1120px] flex flex-col items-center gap-[16px]">
            ...
            <div className="flex flex-col items-center gap-[18px] px-4">
              <h2 className="w-full max-w-[651px] font-roboto font-bold text-3xl sm:text-[48px] md:text-[72px] leading-tight sm:leading-[1.18] text-center text-[#171A20]">
                Simplify
                <br />Documents, Sign,
                <br />Collaborate
                <br />Anywhere
      ...
      <section className="w-full flex justify-center bg-white">
        <div className="w-full max-w-[1120px] flex flex-col items-center gap-8 sm:gap-14 py-12 sm:py-[80px] px-4 sm:px-[15px]">
          ...
          <div className="flex items-center gap-2 px-3 sm:px-5 py-2 rounded-lg border-2 border-[#271CEB]">
            ...
            <span className="font-inter font-medium text-base sm:text-lg md:text-[24px] leading-tight sm:leading-[29px] text-[#271CEB]">Popular Integrations</span>
          </div>
          {/* Heading + Sub */}
          <div className="w-full flex flex-col items-center gap-4">
            <h2 className="w-full text-center font-roboto font-bold text-2xl sm:text-[36px] md:text-[48px] leading-tight sm:leading-[1.2] md:leading-[56px] text-[#171A20]">
              Connect Seamlessly
          ...
          <div className="w-full grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 sm:gap-6">
            {/* Shield */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-shield.png" alt="shield" className="w-full h-full object-contain" />
            </div>
            {/* Excel "X" */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-excel.png" alt="Excel" className="w-full h-full object-contain" />
            </div>
            {/* Notes */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-notes.png" alt="Notes" className="w-full h-full object-contain" />
            </div>
            {/* Outlook */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-outlook.png" alt="Outlook" className="w-full h-full object-contain" />
            </div>
            {/* OneDrive */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-onedrive.png" alt="OneDrive" className="w-full h-full object-contain" />
            </div>
            {/* eSign */}
            <div className="w-full aspect-square max-w-[144px] mx-auto bg-white border border-[#D6D6D6] rounded-[15px] flex items-center justify-center p-4">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/figma/sesign/integrations/icon-esign.png" alt="eSign" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
